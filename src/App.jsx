          ...
          <>
            ...
            <section id="contact" className="py-24 bg-gradient-to-r from-blue-800 to-teal-700 text-white">
               <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                  ...
                  <form className="bg-white rounded-2xl p-8 shadow-2xl text-left space-y-6">
                     <div className="grid grid-cols-2 gap-6">
                        <div>
                           <label className="block text-sm font-medium text-slate-700 mb-1">First Name</label>
                           <input type="text" className="w-full px-4 py-2 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-slate-900" />
                        </div>
                        <div>
                     ...
                     <div>
                        ...
                        <input type="email" className="w-full px-4 py-2 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-slate-900" />
                     </div>
                     <div>
                        ...
                        <div className="grid grid-cols-3 gap-4">
                           <label className="border rounded-lg p-3 flex items-center justify-center gap-2 cursor-pointer hover:bg-slate-50 text-slate-600">
                              <input type="radio" name="sites" className="text-blue-600 focus:ring-blue-500" /> 1-10
                           </label>
                           <label className="border rounded-lg p-3 flex items-center justify-center gap-2 cursor-pointer hover:bg-slate-50 text-slate-600">
                              <input type="radio" name="sites" className="text-blue-600 focus:ring-blue-500" /> 11-100
                           </label>
                           <label className="border rounded-lg p-3 flex items-center justify-center gap-2 cursor-pointer hover:bg-slate-50 text-slate-600">
                              <input type="radio" name="sites" className="text-blue-600 focus:ring-blue-500" /> 100+
                           </label>
                        </div>
                     </div>
                     <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Tell us about your assets (optional)</label>
                        <textarea rows="3" className="w-full px-4 py-2 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-slate-900"></textarea>
                     </div>
                     <button type="submit" className="w-full py-4 bg-blue-900 hover:bg-blue-800 text-white font-bold rounded-lg transition text-lg">Request Data Access</button>
                  </form>
               </div>
            </section>
          </>
